...
class NFTCollection(Contract):
    ...
    def __init__(self, **kwargs):
        ...
        self.options["royalty_factor"] = floor(
    ...
    def create_batch_mint_body(
        ...
        for i, (item_content_uri, new_owner_address) in enumerate(contents_and_owners):
            item = Cell()
    ...
    def create_change_owner_body(
        self, new_owner_address: Address, query_id: int = 0
    ) -> Cell:
        body = Cell()
